 ...
 */
 ...
 #ifndef SHARE_GC_SHENANDOAH_SHENANDOAHGCPHASETIMES_HPP
 #define SHARE_GC_SHENANDOAH_SHENANDOAHGCPHASETIMES_HPP
 ...
 class LineBuffer;
 class ShenandoahParScanThreadState;
 
 template <class T> class WorkerDataArray;
 
 class ShenandoahGCPhaseTimes : public CHeapObj<mtGC> {
 ...
 #endif // SHARE_GC_SHENANDOAH_SHENANDOAHGCPHASETIMES_HPP
